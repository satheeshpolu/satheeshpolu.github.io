...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Toggle switch
  const langToggle = document.getElementById("langToggle") as HTMLButtonElement | null;
  const langSlider = document.getElementById("langSlider") as HTMLSpanElement | null;
  const enLabel = document.getElementById("en-label") as HTMLSpanElement | null;
  const deLabel = document.getElementById("de-label") as HTMLSpanElement | null;
